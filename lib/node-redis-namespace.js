...
var NamespaceMulti = function(prefix, multi) {
    ...
    for(var method_name in COMMANDS) {
        NamespaceMulti.prototype[method_name] = function() {
            ...
            return function() {
                ...
                if(COMMANDS[method] == FIRST_KEY) {
                    ...
                    args[length-1] = generate_key(args[length-1]);
                }
                ...
                return multi[method].apply(multi, args);
            };
        }();
    }
...
var RedisNamespaceClient = function(prefix, redis) {
    ...
    RedisNamespaceClient.prototype.multi = function() {
        return new NamespaceMulti(prefix, redis.multi())
    }
}
